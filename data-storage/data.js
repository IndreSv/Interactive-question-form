...
angular.module("myApp").component("answersStorage", {
...
function questions() {
    var vm = this;
    vm.questions = [
    "Which country is yout top destination for travelling?",
    "Which continents have you visited?",
    "What is your main interest in foreign countries?",
    "How often do you travel?",
    "Do you use travel agencies services when travelling?"
  ]
};
